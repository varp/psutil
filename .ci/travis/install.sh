...
if [[ "$(uname -s)" == 'Linux' ]]; then
    ...
    if [[ $ARCH == "32" ]]; then
        ...
        sudo aptitude update && sudo aptitude install -y wget:i386 curl:i386 llvm:i386 build-essential:i386 libc6:i386 libstdc++6:i386 libbz2-dev:i386 \
        ...
        echo "TARGET=$(dpkg-architecture -ai386 -qDEB_HOST_GNU_TYPE); export TARGET" | tee -a ~/.bashrc
        dpkg-architecture -ai386 -s | tee -a ~/.bashrc
    else
